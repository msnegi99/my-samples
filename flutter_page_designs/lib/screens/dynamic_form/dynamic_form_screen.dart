...
class DynamicForm extends StatefulWidget {
  const DynamicForm({super.key, required this.title});
...
class _DynamicFormState extends State<DynamicForm> {
  ...
  myFormType(index) {
    return ListView.separated(
      ...
      itemBuilder: (context, innerIndex) {
        return formResponse[index].fields![innerIndex].fieldType == "DatetimePicker"
               ? myDatePicker()
               : formResponse[index].fields![innerIndex].fieldType == "TextInput"
               ? myTextField(index, innerIndex)
               : formResponse[index].fields![innerIndex].fieldType == "SelectList"
               ? dropDownWidget(formResponse[index].fields![innerIndex].options)
               : formResponse[index].fields![innerIndex].fieldType == "SwitchInput"
               ? mySwitchListTile(index, innerIndex)
  ...
  Widget mySwitchListTile(index, innerIndex) {
  ...
  Widget myTextField(index, innerIndex) {
    return TextField(
