package com.msnegi.composeleftnav.navigation
...
import com.msnegi.composeleftnav.R
...
sealed class Screens(val route: String, val title: String) {
    ...
    sealed class DrawerScreens(
        ...
        object MyProfile : DrawerScreens("my_profile", R.drawable.ic_baseline_person_24, "My Profile")
        object MyReviews : DrawerScreens("my_reviews", R.drawable.ic_baseline_rate_review_24, "My Reviews")
        object VisitsHistory : DrawerScreens("visit_history", R.drawable.ic_baseline_location_on_24, "Visits History")
        object Notifications : DrawerScreens("notifications", R.drawable.ic_baseline_notifications_24, "Notifications")
        object AppSettings : DrawerScreens("settings", R.drawable.ic_baseline_settings_24, "Settings")
