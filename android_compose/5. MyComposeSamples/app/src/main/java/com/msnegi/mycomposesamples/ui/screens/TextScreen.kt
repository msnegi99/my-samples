...
import com.msnegi.mycomposesamples.ui.components.CustomCard
...
fun TextScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            CustomCard(
                imageRes = R.drawable.tower,
                title = "Compose Card",
                description = "This is a custom card component built using Jetpack Compose.",
