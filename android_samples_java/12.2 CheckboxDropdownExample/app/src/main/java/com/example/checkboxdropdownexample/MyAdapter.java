...
{
    private CallbackInterface mContext;
    ...
    public MyAdapter(Context context, int resource, List<StateVO> objects) {
        ...
        this.mContext = (CallbackInterface) context;
    ...
    public View getCustomView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null) {
            LayoutInflater layoutInflator = LayoutInflater.from((MainActivity) mContext);
            convertView = layoutInflator.inflate(R.layout.custom_spinner_item, null);
            holder = new ViewHolder();
            holder.mTextView = (TextView) convertView.findViewById(R.id.txtData);
        ...
        holder.mCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                mContext.callFunction(listState);
            }
        });
        return convertView;
    }
