...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(getLocationReceiver, new IntentFilter("get_location"));
        ...
        stopbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent("stop_location_service");
    ...
    private final BroadcastReceiver getLocationReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent)
        {
            try
            {
                ...
                txtLatLong.setText("Lat : " + locData.getLatitude() + " Long : " + locData.getLongitude());
