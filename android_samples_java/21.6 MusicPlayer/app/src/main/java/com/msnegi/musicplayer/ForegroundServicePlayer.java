...
public class ForegroundServicePlayer extends Service implements OnPreparedListener
{
	...
	public void onCreate() {
		...
		try
		{
			...
			AssetFileDescriptor fd = getResources().openRawResourceFd(R.raw.rihana_disturbia);
		...
		IntentFilter intentFilter = new IntentFilter("com.msnegi.Player");
	...
	public int onStartCommand(Intent intent, int flags, int startId)
	{
		try
		{
			...
			{
				Toast.makeText(this, "Failed to init the Player", Toast.LENGTH_LONG).show();
			}
		}
		catch (Throwable e)
		{
