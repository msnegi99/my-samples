...
import com.msnegi.googlecheckinoutdemo.checkinout.CheckInOutFragment;
import com.msnegi.googlecheckinoutdemo.regularupdate.MyLocationService;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkGPSSettings();
        replaceFragment(new CheckInOutFragment(), new Bundle(), "CheckInOutFragment");
    }
    ...
    public void replaceFragment(Fragment fragment, Bundle bundle, String tag) {
        ...
        if (fragment instanceof CheckInOutFragment) {
