package com.msnegi.drawerlayoutsub.activities;
...
import com.msnegi.drawerlayoutsub.R;
import com.msnegi.drawerlayoutsub.adapters.CustomDrawerAdapter;
import com.msnegi.drawerlayoutsub.fragments.FragmentOne;
import com.msnegi.drawerlayoutsub.fragments.FragmentThree;
import com.msnegi.drawerlayoutsub.fragments.FragmentTwo;
import com.msnegi.drawerlayoutsub.pojo.DrawerItem;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.drawable.ic_drawer, R.string.drawer_open, R.string.drawer_close)  //v4
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, toolbar, R.string.drawer_open, R.string.drawer_close)          //v7
        {
    ...
    public void setDrawerState(boolean isEnabled) {
        if (isEnabled) {
            mDrawerLayout.setDrawerLockMode(DrawerLayout.LOCK_MODE_UNLOCKED, mDrawerLayout);
        } else {
            mDrawerLayout.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED, mDrawerLayout);
        }
