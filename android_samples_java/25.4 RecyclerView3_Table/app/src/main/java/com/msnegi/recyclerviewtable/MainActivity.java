...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ColorDrawable colorDrawable = new ColorDrawable(ContextCompat.getColor(this, R.color.separator));
        recyclerView.addItemDecoration(
                new DividerItemDecoration(
                        this,
                        LinearLayoutManager.VERTICAL,
                        (float) Utilities.dpTopx(this, 0.5f),
                        new ColorDrawable(getResources().getColor(R.color.separator))
            )
        );
        recyclerView.addItemDecoration(
                new DividerItemDecoration(
