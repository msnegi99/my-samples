...
class ClipperPage extends StatefulWidget {
  const ClipperPage({super.key,required this.title,});

   // The widget itself is immutable
  final String title;

  @override
  State<ClipperPage> createState() => _ClipperPageState(); // Creates the mutable state object
}
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text("Sample Code",style: TextStyle(color: Colors.white, fontSize: 30.0),),
                    Text("Flutter Clipper",style: TextStyle(color: Colors.grey, fontSize: 20.0),),
                  ],
                ),
              ],
            ),
