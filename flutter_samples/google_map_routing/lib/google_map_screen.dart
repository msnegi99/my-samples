...
import 'package:google_map_routing/repository/repo.dart';
import 'package:google_map_routing/utils.dart';
...
class _GoogleMapScreenState extends State<GoogleMapScreen> {
  ...
  TextEditingController latitudeController =
      TextEditingController(text: "28.63555341692425");
  TextEditingController longitudeController =
      TextEditingController(text: "77.09583599128848");
  Polyline? routePolyline;
  bool isRouteCreating = false;
  late final GoogleMapController _controller;
  Position? _currentPosition;
  LatLng _currentLatLng = const LatLng(28.620957616908303, 77.07744858931243);
  Marker? secondMarker;
  @override
  void initState() {
    _getLocation();
    ...
    return Container(
      ...
      child: ElevatedButton(
          ...
          onPressed: () async {
            ...
            secondLocationIcon = currentLocationIcon;
