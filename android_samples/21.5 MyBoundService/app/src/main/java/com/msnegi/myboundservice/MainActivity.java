package com.msnegi.myboundservice;
...
//        we use the compatibility library
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this,REQUEST_CODE, startIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);
