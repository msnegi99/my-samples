...
public class CircularRoundImage extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public CircularRoundImage(Context context) {
        super(context);

        init();
    }

    public CircularRoundImage(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularRoundImage(Context context, AttributeSet attrs, int defStyle) {
