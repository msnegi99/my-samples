...
public final class DataToPref {
    ...
    /**
     * Initialize the DataToPref helper class to keep a reference to the SharedPreference for this
    ...
    public static SharedPreferences getPreferences() {
        ...
        throw new RuntimeException(
                "DataToPref class not correctly instantiated. Please call Builder.setContext().build() in the Application class onCreate.");
    }
     ...
     * onCreate. And in the rest of the code base you can call DataToPref.method name.
     */
    public final static class Builder {
        ...
        public void build() {
            if (mContext == null) {
                throw new RuntimeException("Context not set, please set context before building the DataToPref instance.");
            }
            ...
            DataToPref.initPrefs(mContext, mKey, mMode);
        }
