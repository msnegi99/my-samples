...
import com.msnegi.qrcodebarcodeexample.HomeFragment;
import com.msnegi.qrcodebarcodeexample.qrbarcodescanner.NoScanResultException;
...
//        ab.setHomeAsUpIndicator(R.drawable.ic_baseline);
    ...
    QRBarScannerFragment qrbarScannerFragment;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == IntentIntegrator.REQUEST_CODE){
            getSupportFragmentManager().findFragmentByTag("QRBarScannerFragment").onActivityResult(requestCode, resultCode, data);
        }
    }

    public void scanResultException(NoScanResultException noScanData) {
