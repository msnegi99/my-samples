...
public class CustomTransitionFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mScenes = new Scene[] {
                Scene.getSceneForLayout(container, R.layout.scene4, context),
                Scene.getSceneForLayout(container, R.layout.scene5, context),
                Scene.getSceneForLayout(container, R.layout.scene6, context),
        };
